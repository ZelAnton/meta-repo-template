<!-- META(%%): fill the command slots (%%BuildCmd%% / %%TestCmd%% / %%FmtCmd%% / %%LintCmd%%)
     and the Architecture pointer. The Changelog, agent-files-local, and version-control
     sections are neutral. See META-AUTHORING.md. -->
# CLAUDE.md
...
The source lives in `%%SrcLayout%%`. Keep the public API surface small and
intentional, keep implementation details internal, and prefer simple, direct code
