<!-- META(%%): this file is language-neutral — keep the structure as-is. The empty
     [Unreleased] placeholders below are correct for a fresh template. The initializer
     now preserves binary and non-UTF-8 files during token substitution. See META-AUTHORING.md. -->
# Changelog
